...
//        }
        ...
        //fot test
        for (UserMealWithExceed anExceedList : mealExceed) {
            System.out.println(anExceedList.getDateTime() + " " + anExceedList.getDescription() + " " + anExceedList.getCalories() + " " + anExceedList.isExceed());
        }
